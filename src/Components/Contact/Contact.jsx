...
const Contact = () => {
  return (
    <>
      <div className='Heading head'><h2 >Contact <hr /></h2></div>
      <div className='contact'>
        ...
        <div className="right">
          <div className='contact-from'><h3>Location</h3></div>
          <div><p>Mentem Technologies Pvt Ltd. Sardarpura Jodhpur Rajasthan 342008</p></div>
          <div><h4>Follow Us</h4></div>
          <div className='svg'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
